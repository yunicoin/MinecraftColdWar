...
execute store result entity @s Motion[0] double 0.00008 run scoreboard players get @p[tag=vector] vector
execute store result score @s data0 run data get entity @s Motion[0] 50000

execute store result score @p[tag=vector] vector run data get entity @p[tag=vector] Pos[1] -1000
execute store result score @p[tag=vector] math run data get entity @e[limit=1,tag=vector,type=minecraft:text_display] Pos[1] 1000
scoreboard players operation @p[tag=vector] vector += @p[tag=vector] math
execute store result entity @s Motion[1] double 0.0009 run scoreboard players get @p[tag=vector] vector
...
scoreboard players operation @p[tag=vector] vector += @p[tag=vector] math
execute store result entity @s Motion[2] double 0.00008 run scoreboard players get @p[tag=vector] vector
