...
execute store result entity @s Motion[0] double 0.0005 run scoreboard players get @p[tag=vector] vector
...
execute store result entity @s Motion[1] double 0.0005 run scoreboard players get @p[tag=vector] vector
...
execute store result entity @s Motion[2] double 0.0005 run scoreboard players get @p[tag=vector] vector
